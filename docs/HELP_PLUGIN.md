...
- Java：25。
- 插件文件：`VillageTrader-2.0.jar`（v2.0）。
...
构建产物位于 `build/libs/VillageTrader-2.0.jar`。
...
| 章节 | 目标摘要 | 阶段奖励 |
|---|---|---|
| 1 定居启程 | 制作工作台、睡一晚 | 面包、火把、5 级装备 |
| 2 矿脉勘探 | 8 钻石矿、20 敌对生物 | 采掘补给、10 级装备 |
| 3 下界远征 | 进下界、10 烈焰人、4 残骸 | 黑曜石、抗火 |
| 4 沧海巡航 | 远古守卫者、潮涌核心 | 潮汐补给、水下呼吸 |
| 5 末地远征 | 进末地、末影龙 | 末影补给、缓降、20 级装备 |
| 6 村庄守卫 | 赢得袭击、拾取图腾 | 守卫补给、32 级装备 |
| 7 试炼密室 | 3 旋风人、试炼钥匙 | 试炼补给 |
| 8 凋灵攻坚 | 凋灵、信标 | 终战补给、64 级装备 |
| 9 深暗净化 | 监守者、8 回响碎片 | 幽匿补给 |
| 10 龙魂再临 | 4 末地水晶、末影龙 | 终焉旗帜、255 级装备 |

完成第十章后才可切换困难终局。装备兑换使用当前黑市制裁价格；主线套装为 5/10/20/32/64/255 阶，儿童守护套装为 1/3/5/10/20/32/128 阶，全部套装都包含同档长矛。
