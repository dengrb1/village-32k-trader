...
give @s minecraft:iron_spear[minecraft:custom_name={text:"3级守护长矛",color:"green",italic:false},minecraft:enchantments={"minecraft:sharpness":3,"minecraft:lunge":2,"minecraft:unbreaking":3},minecraft:unbreakable={},minecraft:custom_data={kind:"child_equipment",tier:3,slot:"spear"}]
