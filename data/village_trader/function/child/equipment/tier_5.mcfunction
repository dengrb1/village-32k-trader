...
give @s minecraft:diamond_spear[minecraft:custom_name={text:"5级守护长矛",color:"aqua",italic:false},minecraft:enchantments={"minecraft:sharpness":5,"minecraft:looting":3,"minecraft:lunge":3,"minecraft:unbreaking":5},minecraft:unbreakable={},minecraft:custom_data={kind:"child_equipment",tier:5,slot:"spear"}]
