...
give @s minecraft:diamond_spear[minecraft:custom_name={text:"10级勇气长矛",color:"blue",italic:false},minecraft:enchantments={"minecraft:sharpness":10,"minecraft:looting":5,"minecraft:lunge":5,"minecraft:unbreaking":10},minecraft:unbreakable={},minecraft:custom_data={kind:"child_equipment",tier:10,slot:"spear"}]
