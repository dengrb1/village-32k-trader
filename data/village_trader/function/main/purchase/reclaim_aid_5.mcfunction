execute unless entity @s[tag=village_trader.main_aux_5] run title @s actionbar [{"text":"[村庄商人] 尚未购买「凋灵净化符」，不能补领。","color":"red"}]
...
execute if score @s vt_tmp matches 1.. run title @s actionbar [{"text":"[村庄商人] 「凋灵净化符」仍在身上，无需补领。","color":"yellow"}]
execute if score @s vt_tmp matches 1.. run return 0
function village_trader:main/purchase/give_aid_5
title @s actionbar [{"text":"[村庄商人] 已免费补领「凋灵净化符」。","color":"aqua"}]
