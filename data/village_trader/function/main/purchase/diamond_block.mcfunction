execute unless score @s vt_stage matches 3.. run title @s actionbar [{"text":"[村庄商人] 尚未解锁：钻石块×16。","color":"red"}]
...
execute if score @s vt_ok matches 1 run give @s minecraft:diamond_block 16
execute if score @s vt_ok matches 1 run title @s actionbar [{"text":"[村庄商人] 已兑换 钻石块×16。","color":"green"}]
