execute unless score @s vt_stage matches 2.. run title @s actionbar [{"text":"[村庄商人] 尚未解锁：钻石×64。","color":"red"}]
...
execute if score @s vt_ok matches 1 run give @s minecraft:diamond 64
execute if score @s vt_ok matches 1 run title @s actionbar [{"text":"[村庄商人] 已兑换 钻石×64。","color":"green"}]
