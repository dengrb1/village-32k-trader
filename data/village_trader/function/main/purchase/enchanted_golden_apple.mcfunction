execute unless score @s vt_stage matches 4.. run title @s actionbar [{"text":"[村庄商人] 尚未解锁：附魔金苹果×2。","color":"red"}]
...
execute if score @s vt_ok matches 1 run give @s minecraft:enchanted_golden_apple 2
execute if score @s vt_ok matches 1 run title @s actionbar [{"text":"[村庄商人] 已兑换 附魔金苹果×2。","color":"green"}]
