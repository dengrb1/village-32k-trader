execute unless score @s vt_stage matches 6.. run title @s actionbar [{"text":"[村庄商人] 尚未解锁：下界合金锭×8。","color":"red"}]
...
execute if score @s vt_ok matches 1 run give @s minecraft:netherite_ingot 8
execute if score @s vt_ok matches 1 run title @s actionbar [{"text":"[村庄商人] 已兑换 下界合金锭×8。","color":"green"}]
