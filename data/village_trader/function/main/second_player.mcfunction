...
execute if score @s vt_qactive matches 1 if score @s vt_a matches 9.. run scoreboard players set @s vt_a 8
execute if score @s vt_qactive matches 1 if score @s vt_b matches 21.. run scoreboard players set @s vt_b 20
execute if score @s vt_qactive matches 2 if score @s vt_a matches 2.. run scoreboard players set @s vt_a 1
execute if score @s vt_qactive matches 2 if score @s vt_b matches 11.. run scoreboard players set @s vt_b 10
execute if score @s vt_qactive matches 2 if score @s vt_c matches 5.. run scoreboard players set @s vt_c 4
execute if score @s vt_qactive matches 3 if score @s vt_a matches 2.. run scoreboard players set @s vt_a 1
execute if score @s vt_qactive matches 3 if score @s vt_b matches 2.. run scoreboard players set @s vt_b 1
