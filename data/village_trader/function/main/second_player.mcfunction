...
execute if score @s vt_qactive matches 1 if score @s vt_c matches 9.. run scoreboard players set @s vt_c 8
...
execute if score @s vt_qactive matches 2 if score @s vt_c matches 9.. run scoreboard players set @s vt_c 8
...
execute if score @s vt_qactive matches 3 if score @s vt_d matches 6.. run scoreboard players set @s vt_d 5
...
execute if score @s vt_qactive matches 4 if score @s vt_c matches 2.. run scoreboard players set @s vt_c 1
...
execute if score @s vt_qactive matches 5 if score @s vt_c matches 2.. run scoreboard players set @s vt_c 1
...
execute if score @s vt_qactive matches 6 if score @s vt_c matches 2.. run scoreboard players set @s vt_c 1
...
execute if score @s vt_qactive matches 7 if score @s vt_c matches 4.. run scoreboard players set @s vt_c 3
...
execute if score @s vt_qactive matches 8 if score @s vt_c matches 4.. run scoreboard players set @s vt_c 3
...
execute if score @s vt_qactive matches 9 if score @s vt_c matches 2.. run scoreboard players set @s vt_c 1
...
execute if score @s vt_qactive matches 10 if score @s vt_c matches 5.. run scoreboard players set @s vt_c 4
...
execute if score @s vt_aux matches 7 run function village_trader:main/effect/builder
execute if score @s vt_aux matches 8 run function village_trader:main/effect/traveler
function village_trader:main/effect/auxiliary_state
