...
execute if score @s vt_action matches 210..228 run function village_trader:main/purchase/route_goods
execute if score @s vt_action matches 190..193 run function village_trader:main/purchase/route_quantity
...
execute if score @s vt_action matches 131..138 run function village_trader:main/purchase/route_aids
execute if score @s vt_action matches 141..148 run function village_trader:main/purchase/route_reclaim_aids
execute if score @s vt_action matches 150..157 run function village_trader:main/equipment/route
execute if score @s vt_action matches 500..551 run function village_trader:main/equipment/route
