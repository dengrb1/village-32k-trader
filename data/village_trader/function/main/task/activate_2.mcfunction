...
scoreboard players add @s vt_mredstone 0
scoreboard players add @s vt_mdredstone 0
scoreboard players operation @s vt_bredstone = @s vt_mredstone
scoreboard players operation @s vt_bdredstone = @s vt_mdredstone
