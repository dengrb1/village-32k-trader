...
execute unless score @s vt_qactive matches 4 run scoreboard players set @s vt_ok 0
...
execute if score @s vt_ok matches 1 run function village_trader:main/task/complete_4
