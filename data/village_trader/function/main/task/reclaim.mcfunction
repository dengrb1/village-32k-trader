...
execute if score @s vt_qactive matches 11 run title @s actionbar [{"text":"[村庄商人] 十章主线已经完成，不能补领。","color":"red"}]
...
execute if score @s vt_qactive matches 7 run function village_trader:main/task/reclaim_7
execute if score @s vt_qactive matches 8 run function village_trader:main/task/reclaim_8
execute if score @s vt_qactive matches 9 run function village_trader:main/task/reclaim_9
execute if score @s vt_qactive matches 10 run function village_trader:main/task/reclaim_10
