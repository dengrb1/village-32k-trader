...
execute store result score @s vt_tmp run clear @s minecraft:end_crystal 0
...
execute if score @s vt_ok matches 1 run function village_trader:main/task/commit_10
