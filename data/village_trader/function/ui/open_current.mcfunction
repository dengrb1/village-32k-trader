...
execute if score @s vt_ui matches 2 run dialog show @s village_trader:main_equipment
execute if score @s vt_ui matches 3 run dialog show @s village_trader:main_resources
execute if score @s vt_ui matches 4 run dialog show @s village_trader:main_consumables
...
execute if score @s vt_ui matches 6 run dialog show @s village_trader:main_aids
...
execute if score @s vt_ui matches 8 run dialog show @s village_trader:main_settings
execute if score @s vt_ui matches 21 run dialog show @s village_trader:child_root
execute if score @s vt_ui matches 22 run dialog show @s village_trader:child_resources
execute if score @s vt_ui matches 23 run dialog show @s village_trader:child_consumables
...
execute if score @s vt_ui matches 25 run dialog show @s village_trader:child_auxiliary
...
execute if score @s vt_ui matches 27 run dialog show @s village_trader:child_boss
...
execute if score @s vt_ui matches 30 run dialog show @s village_trader:child_equipment
