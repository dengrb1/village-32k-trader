execute if entity @s[tag=village_trader.ach.guardian_07] run return 0
tag @s add village_trader.ach.guardian_07
scoreboard players add @s vt_ach_total 1
scoreboard players add @s vt_ach_guardian 1
title @s actionbar [{"text":"[成就·守护] 守护升格","color":"light_purple"}]
