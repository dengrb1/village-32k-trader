...
public final class VillageTraderPlugin extends JavaPlugin {
  ...
  @Override public void onEnable(){
    ...
    items=new ItemService(this);tasks=new TaskService(this,profiles,items);bossBars=new BossBarService(profiles,tasks);shop=new ShopService(this,profiles,serverState,items,tasks);effects=new EffectsService(this,profiles,items);merchants=new MerchantService(this,profiles,serverState,items,shop,tasks);legacy=new LegacyMigrator(items,serverState);if(serverState.createdNew())legacy.migrateServerState();
