...
public final class TaskDefinitions {
  ...
  static {
    main(1, "矿工试炼", goal("diamonds", "钻石矿", 8), goal("hostiles", "敌对生物", 20));
    main(2, "下界通行", goal("nether", "进入下界", 1), goal("blazes", "烈焰人", 10), goal("debris", "远古残骸", 4));
    main(3, "末地追踪", goal("end", "进入末地", 1), goal("dragon", "末影龙", 1));
    main(4, "村庄守卫", goal("raid", "赢得袭击", 1), goal("totem", "亲自拾取图腾", 1));
    main(5, "凋灵挑战", goal("wither", "凋灵", 1), goal("beacon", "制作信标", 1));
    main(6, "深暗挑战", goal("warden", "监守者", 1));
